...
**Review**
The list of Review items visitors see. Use <code>Add Review</code> for each item.

**Name**
Sets the name value for this review section.

**Title**
The primary title for this item.

**Area or Company**
Sets the area or company value for this review section.

**Description**
Optional longer text for this section. Use it when visitors need more context than the intro provides.

**Photo**
Optional image used by this item or section. Use consistent image sizes where possible for a cleaner layout. Recommended Size: 500px by 500px.
